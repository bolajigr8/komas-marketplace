...
//   // Load default Rivers State pickup station on component mount
//   useEffect(() => {
//     const loadDefaultPickupStation = async () => {
//       if (!defaultStationLoaded) {
//         try {
//           // console.log('Loading default Rivers State pickup stations for form...')
//           const response = await fetchPickupStations({ region: 'Rivers' })
//           const stations = response?.data || []

//           // console.log('Default Rivers State stations found for form:', stations)
