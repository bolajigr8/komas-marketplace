...
import ProductDescription from '../ProductDetailsPage/ProductDesc'
...
const CartProductCard = ({ cartItem }: { cartItem: CartItem }) => {
  ...
  return (
    <div className='bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200'>
      <div className='flex items-start gap-4 p-4'>
        ...
        <div className='flex-1 min-w-0'>
          <div className='flex flex-col lg:flex-row lg:items-start lg:justify-between gap-3'>
            ...
            {/* Cart Counter */}
            <div className=' hidden sm:flex sm:flex-shrink-0 lg:ml-4'>
              <CartCounter
                path='cart'
      ...
      {/* Cart Counter - very small screens  */}
      <div className='sm:hidden flex flex-shrink-0 justify-center items-center p-4'>
        <CartCounter
          path='cart'
          productId={cartItem.product._id}
          variantId={
            hasVariant && cartItem.variant ? cartItem.variant._id : undefined
          }
          initialQuantity={cartItem.quantity}
          maxQuantity={
            hasVariant && cartItem.variant
