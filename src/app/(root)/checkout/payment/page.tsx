...
//   // Fixed delivery and tax fees
//   // const deliveryFee = 0;
//   const taxFee = 100
//   // const totalAmount = subtotal + deliveryFee + taxFee;
...
//   return (
//     <div className='max-w-6xl w-full mx-auto flex flex-col gap-6 p-4 md:p-6'>
